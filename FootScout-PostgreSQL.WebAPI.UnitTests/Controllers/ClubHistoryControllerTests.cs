...
namespace FootScout_PostgreSQL.WebAPI.UnitTests.Controllers
{
    public class ClubHistoryControllerTests
    {
        ...
        public ClubHistoryControllerTests()
        {
            ...
            _clubHistoryController = new ClubHistoryController(_mockClubHistoryRepository.Object,_mockAchievementsRepository.Object, _mockPlayerPositionRepository.Object, _mockMapper.Object);
        }
