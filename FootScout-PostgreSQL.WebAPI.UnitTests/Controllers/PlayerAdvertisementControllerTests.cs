using AutoMapper;
using FootScout_PostgreSQL.WebAPI.Controllers;
...
namespace FootScout_PostgreSQL.WebAPI.UnitTests.Controllers
{
    public class PlayerAdvertisementControllerTests
    {
        ...
        public PlayerAdvertisementControllerTests()
        {
            ...
            _playerAdvertisementController = new PlayerAdvertisementController(_mockPlayerAdvertisementRepository.Object, _mockSalaryRangeRepository.Object, _mockPlayerPositionRepository.Object, _mockPlayerFootRepository.Object, _mockMapper.Object);}
