using AutoMapper;
using FootScout.WebAPI.Controllers;
...
namespace FootScout_PostgreSQL.WebAPI.UnitTests.Controllers
{
    public class PlayerOfferControllerTests
    {
        ...
        public PlayerOfferControllerTests()
        {
            ...
            _playerOfferController = new PlayerOfferController(_mockPlayerOfferRepository.Object, _mockOfferStatusRepository.Object, _mockPlayerPositionRepository.Object, _mockPlayerFootRepository.Object, _mockMapper.Object);
        }
