...
namespace FootScout_PostgreSQL.WebAPI.UnitTests.Controllers
{
    public class ClubOfferControllerTests
    {
        ...
        public ClubOfferControllerTests()
        {
            ...
            _clubOfferController = new ClubOfferController(_mockClubOfferRepository.Object, _mockOfferStatusRepository.Object, _mockPlayerPositionRepository.Object, _mockMapper.Object);
        }
