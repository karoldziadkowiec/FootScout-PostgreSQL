...
const AdminPlayerAdvertisements = () => {
    ...
    const handleDeleteAdvertisement = async () => {
        ...
        try {
            await PlayerAdvertisementService.deletePlayerAdvertisement(deleteAdvertisementId);
    ...
    const filterAdvertisementsByStatus = (advertisements: PlayerAdvertisement[]) => {
                ...
                <Table striped bordered hover variant="light">
                    ...
                    <tbody>
                        {currentPlayerAdvertisementItems.length > 0 ? (
                            currentPlayerAdvertisementItems.map((advertisement, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="ad-row">
                                        ...
                                        {(advertisement.playerId !== userId) && (
                                            <>
                                                <span className="button-spacing">|</span>
                                                <Button variant="info" onClick={() => handleOpenChat(advertisement.playerId)}>
                            ...
                            <tr>
                                <td colSpan={8} className="text-center">No player advertisement available</td>
                            </tr>
                        )}
                    </tbody>
                </Table>
...
export default AdminPlayerAdvertisements;